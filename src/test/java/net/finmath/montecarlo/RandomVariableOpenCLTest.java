...
public class RandomVariableOpenCLTest {
	...
	public void testRandomVariableDeterministc() {
		...
		RandomVariable randomVariable = new RandomVariableOpenCL(2.0);
	...
	public void testRandomVariableAverage() throws InterruptedException {
		...
		final RandomVariable randomVariable = new RandomVariableOpenCL(0.0,values);
	...
	public void testRandomVariableArithmeticSqrtPow() {
		...
		final RandomVariable randomVariable = new RandomVariableOpenCL(0.0, new double[] {3.0, 1.0, 0.0, 2.0, 4.0, 1.0/3.0} );

		final RandomVariable check = randomVariable.sqrt().sub(randomVariable.pow(0.5));

		// The random variable is identical 0.0
		Assert.assertEquals(0.0, check.getAverage(), 1E-7);
		Assert.assertEquals(0.0, check.getVariance(), 1E-7);
	}
	...
	public void testRandomVariableArithmeticSquaredPow() {
		...
		// Create a stochastic random variable
		final RandomVariable randomVariable = new RandomVariableOpenCL(0.0,
	...
	public void testRandomVariableStandardDeviation() {
		...
		Assert.assertEquals(Math.sqrt(randomVariable.getVariance()), randomVariable.getStandardDeviation(), 1E-7);
	}
	...
	public void testRandomVariableOpenCL() throws InterruptedException {
		...
		for(int testRun=0; testRun<10; testRun++) {
			...
			final AbstractRandomVariableFactory[] rvf = { new RandomVariableFloatFactory(), new RandomVariableOpenCLFactory() };
