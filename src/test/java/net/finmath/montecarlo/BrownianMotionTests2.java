...
public class BrownianMotionTests2 {

	@Parameters
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				{ "BrownianMotion" },	// Text case 1: Java implementation
				{ "BrownianMotionCudaWithHostRandomVariable" },	// Text case 1: Java implementation
				{ "BrownianMotionCudaWithRandomVariableCuda" }	// Text case 1: Java implementation			
		});
	}
	...
	public BrownianMotionTests2(String testCase) {
	...
	public void testScalarValuedBrownianMotionTerminalDistribution() {
		...
		//		for(int numberOfPaths = 1000; numberOfPaths <= 100000000/10; numberOfPaths *= 10) {
		for(int i=0; i<10000; i++) {
			System.out.println("Run " + i);
			for(int numberOfPaths = 1000000; numberOfPaths <= 1000000; numberOfPaths *= 10) {
	...
	public void testScalarValuedBrownianMotionWithJarqueBeraTest() {
		...
		// Test the quality of the Brownian motion
		BrownianMotionJavaRandom brownian = new BrownianMotionJavaRandom(
				timeDiscretization,
				1,
				numberOfPaths,
				seed
